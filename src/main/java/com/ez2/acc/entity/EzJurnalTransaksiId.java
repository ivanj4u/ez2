...
@Embeddable
public class EzJurnalTransaksiId implements Serializable {

	private long idJurnalTransaksi;
	private long jurnalId;

	public EzJurnalTransaksiId() {
	}

	public EzJurnalTransaksiId(long idJurnalTransaksi, long jurnalId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EzJurnalTransaksiId))
			return false;
		EzJurnalTransaksiId castOther = (EzJurnalTransaksiId) other;
